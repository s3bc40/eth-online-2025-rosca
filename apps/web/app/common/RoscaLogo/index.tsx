  ...
  return (
    <div className="flex flex-col items-center gap-8">
      ...
      >
        ...
        {/* Rotating arrows indicating cycle */}
        <g
      ...
      <div className="flex flex-col items-center gap-2">
        <h1 className="text-6xl tracking-tight bg-gradient-to-r from-indigo-500 via-purple-500 to-fuchsia-500 bg-clip-text text-transparent">
          ROSCA
        </h1>
